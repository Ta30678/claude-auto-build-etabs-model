...
from golden_scripts.tools.geometry import (
    point_in_polygon, point_to_segment_distance, point_in_or_near_polygon,
    polygon_area, is_non_rectangular,
)
...
def filter_by_outline(columns, beams, walls, outline,
                      substructure_outline=None, tolerance=0.10):
